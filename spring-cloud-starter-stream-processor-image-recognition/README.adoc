...
A processor that uses use Inception-v3 model (https://github.com/tensorflow/models/tree/master/inception) to classify
in real-time images into 1000 classes.
...
The result is Tuple (or JSON) message in this format:
