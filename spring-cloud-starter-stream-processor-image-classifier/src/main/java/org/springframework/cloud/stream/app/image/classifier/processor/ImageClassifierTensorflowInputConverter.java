 ...
 */
public class ImageClassifierTensorflowInputConverter implements TensorflowInputConverter, AutoCloseable {

	private static final Log logger = LogFactory.getLog(ImageClassifierTensorflowInputConverter.class);

	private final Graph graph;

	private final Output graphOutput;

	public ImageClassifierTensorflowInputConverter() {
		graph = new Graph();
