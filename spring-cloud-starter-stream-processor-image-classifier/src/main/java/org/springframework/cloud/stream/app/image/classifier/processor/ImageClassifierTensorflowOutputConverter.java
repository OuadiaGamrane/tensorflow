 ...
 */
public class ImageClassifierTensorflowOutputConverter implements TensorflowOutputConverter<Tuple> {

	private static final Log logger = LogFactory.getLog(ImageClassifierTensorflowOutputConverter.class);

	private final List<String> labels;

	private final int responseSize;

	public ImageClassifierTensorflowOutputConverter(Resource labels, int responseSize) {
